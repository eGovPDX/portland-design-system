...
describe("Banner Component", () => {
  test("renders banner with default props", () => {
    ...
    const domainText = screen.getByText(
      /An official website of the City of Portland/i,
    );
  ...
  test("can render without HTTPS guidance", () => {
    render(<Banner showHttpsGuidance={false} initiallyExpanded={true} />);
    ...
    expect(
      screen.queryByText(/Secure websites use HTTPS/i),
    ).not.toBeInTheDocument();
  });
